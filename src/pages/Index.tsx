  ...
  return <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8 sm:py-12">
        ...
        <header className="text-center mb-10 sm:mb-14">
          ...
          <p className="text-muted-foreground text-lg max-w-md mx-auto">Your companion for mastering a second language.</p>
        </header>

        {/* Main Content */}
        <main className="max-w-2xl mx-auto">
          {selectedNounId ? <NounDeepDive nounId={selectedNounId} onBack={() => setSelectedNounId(null)} /> : <div className="space-y-8">
