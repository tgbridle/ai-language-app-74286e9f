    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8 sm:py-12">
        ...
        <header className="text-center mb-10 sm:mb-14">
          ...
          <p className="text-foreground/80 text-lg font-medium">Search, learn, remember</p>
          <p className="text-muted-foreground text-lg mt-1">Your language learning companion</p>
        </header>
