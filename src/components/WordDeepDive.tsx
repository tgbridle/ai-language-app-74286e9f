...
export function WordDeepDive({ entryId, onBack }: WordDeepDiveProps) {
  ...
  const renderTypeSpecificContent = () => {
    switch (entry.word_type) {
      ...
      case 'article':
        // Article has its own full-page component - return null here
        // The parent will render ArticleDeepDive instead
        return null;
  ...
  // Conjunction gets its own dedicated layout
  ...
  // Article gets its own dedicated layout
